...
(defun gpt-faster-correct-region-to-idiomatic-swedish ()
  (interactive)
  (gpt-process-region "gpt-3.5-turbo" "copyrwriter and editor" "Rätta följande till bra idiomatisk svenska"))

(defun gpt-smarter-correct-region-to-idiomatic-swedish ()
  (interactive)
  (gpt-process-region "gpt-smarter-turbo" "copyrwriter and editor" "Rätta följande till bra idiomatisk svenska"))

(defun gpt-faster-correct-region-to-idiomatic-finnish ()
  (interactive)
  (gpt-process-region "gpt-3.5-turbo" "copyrwriter and editor" "Korjaa ja stilisoi seuraava hyväksi suomenkieleksi"))

(defun gpt-smarter-correct-region-to-idiomatic-finnish ()
  (interactive)
  (gpt-process-region "gpt-smarter-turbo" "copyrwriter and editor"  "Korjaa ja stilisoi seuraava hyväksi suomenkieleksi"))
...
(global-set-key (kbd "C-c C-g C-i C-e C-f") 'gpt-faster-correct-region-to-idiomatic-english)
(global-set-key (kbd "C-c C-g C-i C-e C-s") 'gpt-smarter-correct-region-to-idiomatic-english)
(global-set-key (kbd "C-c C-g C-i C-f C-f") 'gpt-faster-correct-region-to-idiomatic-finnish)
(global-set-key (kbd "C-c C-g C-i C-f C-s") 'gpt-smarter-correct-region-to-idiomatic-finnish)
(global-set-key (kbd "C-c C-g C-i C-s C-f") 'gpt-faster-correct-region-to-idiomatic-swedish)
(global-set-key (kbd "C-c C-g C-i C-s C-s") 'gpt-smarter-correct-region-to-idiomatic-swedish)
...
(global-set-key (kbd "C-c C-g C-d C-f") 'gpt-faster-insert-docstring)
(global-set-key (kbd "C-c C-g C-d C-s") 'gpt-smarter-insert-docstring)
